...
class PhotoModelAdapter extends TypeAdapter<PhotoModel> {
  ...
  PhotoModel read(BinaryReader reader) {
    ...
    return PhotoModel(
      ...
      links: fields[12] as PhotoModelLinks?,
...
class PhotoModelLinksAdapter extends TypeAdapter<PhotoModelLinks> {
  @override
  final int typeId = 2;

  @override
  PhotoModelLinks read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
  ...
  @override
  void write(BinaryWriter writer, PhotoModelLinks obj) {
    writer
      ..writeByte(4)
      ..writeByte(1)
      ..write(obj.self)
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is PhotoModelLinksAdapter &&
          runtimeType == other.runtimeType &&
          typeId == other.typeId;
}
