...
class LuxuryDetail extends StatefulWidget {
  LuxuryDetail(this.luxury,{Key? key}) : super(key: key);
  LuxuryModel luxury;
  @override
  State<LuxuryDetail> createState() => _LuxuryDetailState();
}

class _LuxuryDetailState extends State<LuxuryDetail> {
  @override
          ...
          child: Column(
            children: [
              Stack(children: [
                Container(
                  child: FadeInImage(
                    image: NetworkImage(widget.luxury.urls!.small!),
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      TextButton(
                                        onPressed:() async{
                                          await saveGallery(widget.luxury.urls!.small!);
                                        },
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                  ...
                                  widget.luxury.user!.name!,
                                  style: TextStyle(fontWeight: FontWeight.w700,
                                      fontSize: 18)),
                              SizedBox(height: 5,),
                              Text("${widget.luxury.likes} followers",
