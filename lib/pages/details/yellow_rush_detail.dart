...
class YellowRushDetail extends StatefulWidget {
   YellowRushDetail(this.details,{Key? key}) : super(key: key);
  YellowRushModel details;
  @override
  State<YellowRushDetail> createState() => _YellowRushDetailState();
}

class _YellowRushDetailState extends State<YellowRushDetail> {
  @override
          ...
          child: Column(
            children: [
              Stack(children: [
                Container(
                  child: FadeInImage(
                    image: NetworkImage(widget.details.urls!.small!),
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      TextButton(
                                        onPressed:() async{
                                          await saveGallery(widget.details.urls!.small!);
                                        },
                            ...
                            children: [
                              Text(
                                  ...
                                  style: TextStyle(fontWeight: FontWeight.w700,
                                      fontSize: 18)),
                              SizedBox(height: 5,),
                              Text("${widget.details.likes} followers",
                                                    ...
                                                    children: [
                                                      Column(
                                                        children: [
                                                          InkWell(
                                                              onTap: () async {
                                                                launchUrl(Uri.parse("https://t.me/+wCysFA83ZHtiYTQy"), mode: LaunchMode.externalApplication);
                                                              },
                                                              child: SizedBox(
                                                                  height: 50,
                                                                  width: 50,
                                                                  child: ClipRRect(
                                                                    ...
                                                                    child: Image.asset("assets/images/i (20).webp", fit: BoxFit.cover),))),
                                                          SizedBox(height: 8),
                                                          Text("Telegram",
                                                          ...
                                                          InkWell(
                                                              ...
                                                              child: SizedBox(
                                                                  ...
                                                                  child: ClipRRect(
                                                                    borderRadius:
                                                                    BorderRadius.circular(300),
                                                                    child: Image.asset("assets/images/i (21).webp",
                                                                        fit: BoxFit.cover),
                                                                  ))),
                                                          SizedBox(height: 8),
                                                          Text("Instagram",
